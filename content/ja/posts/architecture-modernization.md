...
description: "『アーキテクチャモダナイゼーション ―組織とビジネスの未来を設計する』の書評。Nick Tuneらによる原著の邦訳で、モダナイゼーションを技術・組織・戦略を一体で扱う社会技術的な営みとして描く一冊。BVSSHによる価値評価やウォードリーマッピングなど、ビジネス目標を起点に進める手法を紹介する。"
