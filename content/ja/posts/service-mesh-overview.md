...
description: "サービスメッシュについて調べたことをまとめた記事です。分散システムにおけるサービス間の通信を管理するためのネットワークインフラであるサービスメッシュとは何かを、サイドカープロキシの仕組みや、IstioとLinkerdによるトラフィック管理・可観測性の実現方法とあわせて解説します。"
