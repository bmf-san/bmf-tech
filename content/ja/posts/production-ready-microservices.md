...
description: "『プロダクションレディマイクロサービス ―運用に強い本番対応システムの実装と標準化』の書評。マイクロサービスを本番運用するために満たすべき要件を、安定性・信頼性・スケーラビリティ・耐障害性などの観点で整理し、標準化チェックリストとして提示する一冊。著者のUberでの経験がベースになっている。"
