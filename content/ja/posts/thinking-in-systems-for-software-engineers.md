...
description: "『システム思考の世界へ ―複雑化する時代で考え続けるソフトウェア技術者のために』の書評。ソフトウェア技術者がシステム思考を自分の仕事に取り入れる視点で書かれた一冊。ストックとフロー、フィードバックループ、レバレッジポイントといった道具立てを、開発や組織で起きる現象と結びつけて紹介する。"
