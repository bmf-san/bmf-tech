...
description: "DB設計におけるNULLの扱い方を解説する記事です。NULLとは「値が存在しない」または「値が不明」であることを示すもので、通常の値のようには比較できません。三値論理による落とし穴やリレーショナルモデルとの関係をふまえ、NULLを使う場面・避けるべき場面とベストプラクティスをまとめます。"
