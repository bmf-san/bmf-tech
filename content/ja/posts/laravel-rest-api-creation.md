...
# 参考
* [Laravel5.2で認証を用いたAPI作り](http://web.archive.org/web/20210417022405/https://satobukuro.net/173/)
* ~~LaravelでRest APIを開発する~~
* [React.jsでLaravelから情報をもらってみよう](http://web.archive.org/web/20200130035136/http://blog.comnect.jp.net:80/blog/98)・・・Laravel+API+React！
