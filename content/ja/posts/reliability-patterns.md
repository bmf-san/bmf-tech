---
title: 信頼性のパターンについて
description: "信頼性（Reliability）を高めるための設計パターンを、Azure・AWS・GCPが提唱するパターンに基づいてまとめた記事です。ユーザーが期待する機能を提供し続けるために、サーキットブレーカーや補正トランザクション、イベントソーシング、Pub/Subといったパターンを使って耐障害性・回復性を実現する方法を整理します。"
