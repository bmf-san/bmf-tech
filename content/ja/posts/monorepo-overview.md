---
title: "モノレポとは？メリット・デメリットと適切な使い方"
description: "モノレポについてまとめた記事です。複数プロジェクトのコードを単一のリポジトリで管理するモノレポとは何かを、ポリレポ（マルチレポ）との比較を通して説明し、そのメリット・デメリットや適切な使いどころ、導入時に考慮すべきポイントを整理します。"
