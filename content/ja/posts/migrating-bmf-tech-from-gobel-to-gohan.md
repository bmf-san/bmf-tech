...
2. **[Rubel](https://github.com/bmf-san/Rubel) → [gobel](https://github.com/bmf-san/gobel-api)** — Laravelで実装のヘッドレスCMS（後にGo製の[gobel](https://github.com/bmf-san/gobel-api)にリライト）。Vue.jsフロントエンド + MySQLをConoHa VPS上で数年間運用し700件超の記事を蓄積。
