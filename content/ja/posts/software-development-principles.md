---
title: ソフトウェア開発の法則
description: "ポステルの法則、パーキンソンの法則、パレートの法則など、より良いアーキテクチャや設計判断に役立つソフトウェア開発の法則を紹介する記事です。「送信するものには厳密に、受信するものには寛容に」というポステルの法則をはじめ、それぞれの法則の由来や考え方を整理します。"
...
](https://www.yamdas.org/column/technique/19laws.html)
