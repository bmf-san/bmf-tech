...
Aspiring to be an architect who improves the long-term value of organizations and software. I place "what others can achieve through the systems I build" at the center of my values, rather than the code I write myself. I anchor my work in architectural design and decision-making, while stepping into hands-on leadership or organizational work as needed to deliver results. Since organizational and software structures influence each other, I'm also interested in intentionally designing both axes together. Hobbies include OSS development, the gym, and houseplants.
...
| Libraries | [goblin](https://github.com/bmf-san/goblin) | Trie-based HTTP router for Go. |
