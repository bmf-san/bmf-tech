...
**Repository**: [spec-by-bmf-san](https://github.com/bmf-san/spec-by-bmf-san)
...
For details, please refer to the [bmf Framework Specification](https://github.com/bmf-san/spec-by-bmf-san/blob/main/specs/bmf-framework-ja.md).
...
For details, please refer to the [Cynefin Story Point Method Specification](https://github.com/bmf-san/spec-by-bmf-san/blob/main/specs/cynefin-story-points-ja.md).
