...
- [Test-Driven Approach to Solve Testing Pain at PHP Conference Sendai 2019](https://speakerdeck.com/hgsgtk/tesutokaxin-iwojie-jue-surutesutoqu-dong-kai-fa-falseahuroti-at-phpkanhuarensuxian-tai-2019)

- Design decisions from discomfort
 -   In an approach where tests are written after implementation, you might feel discomfort in design when tests are hard to write, but with TDD, getting used to it might be necessary.

# Efforts in a Legacy PHP Application Replacement Project
- [Efforts in a Legacy PHP Application Replacement Project / phpconsen2019](https://speakerdeck.com/blue_goheimochi/phpconsen2019)

- The legacy level seemed "overwhelming," making it hard to stay motivated...
- Even if it's not "overwhelmingly" legacy now, it will become so if left unattended, so I vowed to actively maintain it when I sense a legacy smell.

# Techniques for Considering Recurrence Prevention
- [Techniques for Considering Recurrence Prevention / #phpconsen](https://speakerdeck.com/sota1235/number-phpconsen)
...
- [Review Culture in a Startup's Sixth Year.pdf](https://speakerdeck.com/tsuyoshi/sutatoatuhu6nian-mu-falserehiyuwen-hua-536de593-7b18-48c0-bfdd-6a59581384b6)
...
- [Mastering PHP Middleware](https://speakerdeck.com/hiro_y/phpfalsemiddlewarewo-shi-ikonasutameni)
