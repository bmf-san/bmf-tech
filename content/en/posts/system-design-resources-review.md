...
- [システム設計の面接試験](https://amzn.to/44oiVdI) has been published, so I read it.
    - [System Design Interview – An insider's guide](https://amzn.to/3N8srJE) Japanese translation.
    - Although the content is somewhat familiar if you read [donnemartin/system-design-primer](https://github.com/donnemartin/system-design-primer/blob/master/README-ja.md), I feel like this type of book is not often published in Japan, so it's a book I want to keep on hand.
