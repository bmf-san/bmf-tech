...
The estimation effort is in days rather than rough hours. I thought it would be better to estimate by dividing tasks into hours for accuracy, but private time often has more interruptions (urgent matters, chores, etc.) than company time, so sometimes it's not as flexible as it seems. (Being single, it should be even more challenging when building a family)
Therefore, instead of estimating by hours, I decided to use days to allow for a larger buffer.
...
I have a rough idea of what I want to do, what I should do, and what would be good to do in my head, so I try to create tasks for them.
I don't create tasks on specific days; I create them whenever I think of something to do, whether during work or while out.

Things I want to do are those that pique my technical curiosity.
Things I should do are necessary for work or things that would cause problems if not done.
Things that would be good to do are those that might bring good results in the future or impact my career. Investment activities.
