...
1. **Ask "Who are our customers (users)?"**: Who directly uses our code or system? Clarify what challenges they face and how solving them is the team's "mission."
2. **Understand Domain and Context**: Articulate what role the domain the team faces demands from the team as a personality.
3. **Extract Criteria**: Reflect on past design decisions and extract the common values that guided the team in what they believed was right.
