---
title: Ruby on Rails Code Reading Part 2 - Request Processing in Rails
...
# Overview
Documenting the code reading work for Ruby on Rails.
...
4. Generate a controller with `rails generate controller Example`.
...
By accessing `http://127.0.0.1:3000/example` and running `pry-backtrace` in the console, you can view the stack trace.

Since a lot of output is generated, it’s not possible to follow everything, so I will summarize the key points.

1. Puma accepts the request and invokes the Rails application.
...
- [rack/rack - lib/rack/sendfile.rb#L113](https://github.com/rack/rack/blob/main/lib/rack/sendfile.rb#L113)
  - The Rack application is executed.
2. Resolve routing based on the request information.
  ...
  - [rails/rails - actionpack/lib/action_dispatch/routing/route_set.rb#L66](https://github.com/rails/rails/blob/8bac99ad7a403ef52a5c97e7afa73c7bbcc67110/actionpack/lib/action_dispatch/routing/route_set.rb#L66)
    - Calls the processing of the matched controller in routing.
3. Invoke the index of the controller.
...
It was more complex than I imagined, and since I am not familiar with Ruby, I could only grasp the general idea...

# References
- [speakerdeck.com - Ruby on Rails Hacking Guide](https://speakerdeck.com/a_matsuda/ruby-on-rails-hacking-guide)
- [magazine.rubyist.net - Trying RubyOnRails 【Part 4】 ActionPack](https://magazine.rubyist.net/articles/0008/0008-RubyOnRails.html)