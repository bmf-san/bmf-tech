 ...
 * @param keyPath
 */
export const normalizeTextlintKeyPath = (keyPath) => {
 ...
 */
export const normalizeTextlintPresetSubRuleKey = (names) => {
 ...
 * @param name
 */
export const normalizeTextlintRuleKey = (name) => {
 ...
 * @param name
 */
export const normalizeTextlintFilterRuleKey = (name) => {
 ...
 * @param name
 */
export const normalizeTextlintRulePresetKey = (name) => {
 ...
 * @param name
 */
export const normalizeTextlintPluginKey = (name) => {
