 ...
 */
class TextFixEngine extends textlint_engine_core_js_1.AbstractTextLintEngine {
    constructor(...args) {
        super(...args);
        /**
        ...
        logger_js_1.Logger.deprecate("TextFixEngine is deprecated. Please use new APIs https://github.com/textlint/textlint/issues/1310");
    }
}
