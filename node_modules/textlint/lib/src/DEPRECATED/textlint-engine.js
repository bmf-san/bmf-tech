...
exports.TextLintEngine = void 0;
const linter_formatter_1 = require("@textlint/linter-formatter");
const textlint_engine_core_js_1 = require("./engine/textlint-engine-core.js");
 ...
 */
class TextLintEngine extends textlint_engine_core_js_1.AbstractTextLintEngine {
    constructor(...args) {
        super(...args);
        /**
        ...
        this.onFormat = (formatterConfig) => {
            return (0, linter_formatter_1.createFormatter)(formatterConfig);
        };
        logger_js_1.Logger.deprecate("TextLintEngine is deprecated. Please use new APIs https://github.com/textlint/textlint/issues/1310");
    }
}
