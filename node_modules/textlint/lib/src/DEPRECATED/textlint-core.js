...
const object_to_kernel_format_js_1 = require("../util/object-to-kernel-format.js");
...
class TextLintCore {
    ...
    setupPlugins(plugins = {}, pluginsConfig = {}) {
        ...
        this.textlintKernelDescriptor = this.textlintKernelDescriptor.shallowMerge({
            plugins: (0, object_to_kernel_format_js_1.pluginsObjectToKernelRule)(plugins, pluginsConfig).concat(this.defaultPlugins)
        });
    }
    /**
    ...
    setupRules(rules = {}, rulesOption = {}) {
        logger_js_1.Logger.deprecate("TextLintCore is deprecated. Please use new APIs https://github.com/textlint/textlint/issues/1310");
        this.textlintKernelDescriptor = this.textlintKernelDescriptor.shallowMerge({
            rules: (0, object_to_kernel_format_js_1.rulesObjectToKernelRule)(rules, rulesOption)
        });
    }
    /**
    ...
    setupFilterRules(filterRules = {}, filterRulesOption = {}) {
        this.textlintKernelDescriptor = this.textlintKernelDescriptor.shallowMerge({
            filterRules: (0, object_to_kernel_format_js_1.filterRulesObjectToKernelRule)(filterRules, filterRulesOption)
        });
    }
    /**
    ...
    lintFile(filePath) {
        ...
        const ext = node_path_1.default.extname(absoluteFilePath) || node_path_1.default.basename(absoluteFilePath);
        const options = this._mergeSetupOptions({
            ext,
    ...
    _mergeSetupOptions(options) {
        const configFileBaseDir = typeof this.config.configFile === "string" ? node_path_1.default.dirname(this.config.configFile) : undefined;
        return {
            ...options,
