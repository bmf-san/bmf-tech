...
const config_loader_js_1 = require("./config/config-loader.js");
const preset_loader_js_1 = require("./config/preset-loader.js");
const plugin_loader_js_1 = require("./config/plugin-loader.js");
const textlint_module_resolver_js_1 = require("./engine/textlint-module-resolver.js");
const separate_by_config_option_js_1 = require("./config/separate-by-config-option.js");
...
const defaultOptions = Object.freeze({
    ...
    cacheLocation: node_path_1.default.resolve(process.cwd(), ".textlintcache"),
    // --ignore-path: ".textlintignore" file path
    ignoreFile: node_path_1.default.resolve(process.cwd(), ".textlintignore"),
    // --mcp
    mcp: false
});
...
class Config {
    ...
    static initWithCLIOptions(cliOptions) {
        ...
        options.cacheLocation =
            cliOptions.cacheLocation !== undefined
                ? node_path_1.default.resolve(process.cwd(), cliOptions.cacheLocation)
        ...
        options.ignoreFile =
            cliOptions.ignorePath !== undefined
                ? node_path_1.default.resolve(process.cwd(), cliOptions.ignorePath)
    ...
    static initWithAutoLoading(options = {}) {
        ...
        const loadedResult = typeof options.textlintrc === "undefined" || options.textlintrc
            ? (0, config_loader_js_1.loadConfig)({
        ...
        const configRuleNamesObject = (0, separate_by_config_option_js_1.separateEnabledOrDisabled)(configFileRaw.rules);
        const configFilterRuleNamesObject = (0, separate_by_config_option_js_1.separateEnabledOrDisabled)(configFileRaw.filters);
        const configPresetNames = configRuleNamesObject.presetNames;
        const configFilePlugins = (0, plugin_loader_js_1.getPluginNames)(configFileRaw);
        const configFilePluginConfig = (0, plugin_loader_js_1.getPluginConfig)(configFileRaw);
        ...
        const configFileRulesConfig = (0, preset_loader_js_1.createFlatRulesConfigFromRawRulesConfig)(configFileRaw.rules);
        const configFileFilterRulesConfig = (0, preset_loader_js_1.createFlatRulesConfigFromRawRulesConfig)(configFileRaw.filters);
    ...
    constructor(options = {}) {
        ...
        if (this.configFile) {
            node_assert_1.default.ok(node_path_1.default.isAbsolute(this.configFile), `configFile should be absolute path: ${this.configFile}`);
        }
        ...
        const presetRulesConfig = (0, preset_loader_js_1.loadRulesConfigFromPresets)(this.presets, moduleResolver);
    ...
    _assertCacheLocation(locationPath) {
        let fileStats;
        try {
            fileStats = node_fs_1.default.lstatSync(locationPath);
        }
        catch (ex) {
            fileStats = null;
        }
        ...
        node_assert_1.default.ok(!fileStats.isDirectory(), "--cache-location doesn't support directory");
    }
    toJSON() {
