...
const textlint_core_js_1 = require("../textlint-core.js");
const rule_map_js_1 = require("../../engine/rule-map.js");
const processor_map_js_1 = require("../../engine/processor-map.js");
const config_js_1 = require("../config.js");
const old_find_util_js_1 = require("../../util/old-find-util.js");
const textlint_module_loader_js_1 = require("./textlint-module-loader.js");
...
const debug = (0, debug_1.default)("textlint:engine-core");
/**
...
class AbstractTextLintEngine {
    ...
    constructor(options) {
         ...
         * @type {Config}
         */
        if (options instanceof config_js_1.Config) {
            // Almost internal use-case
            this.config = options;
        }
        else {
            this.config = config_js_1.Config.initWithAutoLoading(options);
        }
        /**
         * @type {TextLintCore}
         * @private
         */
        this.textlint = new textlint_core_js_1.TextLintCore(this.config);
        /**
         * @type {ExecuteFileBackerManager}
         * @private
         */
        this.executeFileBackerManger = new execute_file_backer_manager_js_1.ExecuteFileBackerManager();
        const cacheBaker = new cache_backer_js_1.CacheBacker(this.config);
         ...
         * @private
         */
        this.ruleMap = new rule_map_js_1.RuleMap();
        /**
         * @type {RuleMap} filerRuleMap is used for filtering
         * @private
         */
        this.filterRuleMap = new rule_map_js_1.RuleMap();
        /**
         * @type {PluginMap}
         * @private
         */
        this.pluginMap = new processor_map_js_1.PluginMap();
        /**
         * @type {TextLintModuleLoader}
         * @private
         */
        this.moduleLoader = new textlint_module_loader_js_1.TextLintModuleLoader(this.config);
        this.moduleLoader.on(textlint_module_loader_js_1.TextLintModuleLoader.Event.rule, ([ruleName, ruleCreator]) => {
            this.ruleMap.defineRule(ruleName, ruleCreator);
        });
        this.moduleLoader.on(textlint_module_loader_js_1.TextLintModuleLoader.Event.filterRule, ([ruleName, ruleCreator]) => {
            this.filterRuleMap.defineRule(ruleName, ruleCreator);
        });
        this.moduleLoader.on(textlint_module_loader_js_1.TextLintModuleLoader.Event.plugin, ([pluginName, plugin]) => {
...
new TextLintEngine({
 rulesBaseDirectory: directory
    ...
    executeOnFiles(files) {
        ...
        const patterns = (0, old_find_util_js_1.pathsToGlobPatterns)(files, {
            extensions: this.textlintrcDescriptor.availableExtensions
        });
        const targetFiles = (0, old_find_util_js_1.findFiles)(patterns, { ignoreFilePath: this.config.ignoreFile });
    ...
    executeOnText(text, ext = ".txt") {
        ...
        // filePath or ext
        const actualExt = ext[0] === "." ? ext : node_path_1.default.extname(ext);
    ...
    isErrorMessage(message) {
        return message.severity === SeverityLevel_js_1.SeverityLevel.error;
    }
    /**
