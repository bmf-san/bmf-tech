...
const config_util_js_1 = require("../config/config-util.js");
const rule_loader_js_1 = require("../../engine/rule-loader.js");
const logger_js_1 = require("../../util/logger.js");
const textlint_module_resolver_js_1 = require("./textlint-module-resolver.js");
const textlint_module_mapper_js_1 = require("./textlint-module-mapper.js");
const utils_1 = require("@textlint/utils");
const node_fs_1 = __importDefault(require("node:fs"));
const debug = (0, debug_1.default)("textlint:module-loader");
...
class TextLintModuleLoader extends node_events_1.EventEmitter {
    static get Event() {
        return {
            rule: "rule",
    ...
    constructor(config) {
        super();
        this.moduleResolver = new textlint_module_resolver_js_1.TextLintModuleResolver(config);
    }
    /**
    ...
    loadFromConfig(config) {
        ...
        if (config.rulePaths && this.listenerCount(TextLintModuleLoader.Event.rule) > 0) {
            ...
            config.rulePaths.forEach((rulesDir) => {
                ...
                const rules = (0, rule_loader_js_1.loadFromDir)(rulesDir);
...
For more details. See https://github.com/textlint/textlint/blob/master/docs/plugin.md`);
    ...
    loadPreset(presetName) {
        ...
        if ((0, config_util_js_1.isPluginRuleKey)(presetRuleNameWithoutPrefix)) {
            logger_js_1.Logger.warn(`${presetRuleNameWithoutPrefix} is Plugin's rule. This is unknown case, please report issue.`);
            return;
        }
        ...
        const entities = textlint_module_mapper_js_1.TextLintModuleMapper.createEntities(preset.rules, presetRuleNameWithoutPrefix);
    ...
    loadRule(ruleName) {
        ...
        */
        ...
        // ignore plugin's rule
        if ((0, config_util_js_1.isPluginRuleKey)(definedRuleName)) {
            logger_js_1.Logger.warn(`${definedRuleName} is Plugin's rule. This is unknown case, please report issue.`);
            return;
        }
