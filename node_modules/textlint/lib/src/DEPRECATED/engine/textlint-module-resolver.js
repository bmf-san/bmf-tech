...
const textlint_package_name_util_js_1 = require("../textlint-package-name-util.js");
const package_prefix_js_1 = require("../config/package-prefix.js");
...
class TextLintModuleResolver {
    ...
    resolveRulePackageName(packageName) {
        ...
        const fullPackageName = (0, textlint_package_name_util_js_1.createFullPackageName)(package_prefix_js_1.PackageNamePrefix.rule, packageName);
...
`);
    ...
    resolveFilterRulePackageName(packageName) {
        const baseDir = this.baseDirectory;
        const fullPackageName = (0, textlint_package_name_util_js_1.createFullPackageName)(package_prefix_js_1.PackageNamePrefix.filterRule, packageName);
...
`);
    ...
    resolvePluginPackageName(packageName) {
        const baseDir = this.baseDirectory;
        const fullPackageName = (0, textlint_package_name_util_js_1.createFullPackageName)(package_prefix_js_1.PackageNamePrefix.plugin, packageName);
...
`);
    ...
    resolvePresetPackageName(packageName) {
        const baseDir = this.baseDirectory;
        const PREFIX = package_prefix_js_1.PackageNamePrefix.rulePreset;
        /* Implementation Note
        ...
        const packageNameWithoutPreset = packageName
            .replace(/^preset-/, "")
            .replace(/^@([^/]+)\/preset-(.*)$/, `@$1/$2`);
        const fullPackageName = (0, textlint_package_name_util_js_1.createFullPackageName)(PREFIX, packageNameWithoutPreset);
...
`);
    ...
    resolveConfigPackageName(packageName) {
        const baseDir = this.baseDirectory;
        const fullPackageName = (0, textlint_package_name_util_js_1.createFullPackageName)(package_prefix_js_1.PackageNamePrefix.config, packageName);
