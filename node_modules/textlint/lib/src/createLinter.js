...
const createLinter = (options) => {
    ...
    const executeFileBackerManger = new execute_file_backer_manager_js_1.ExecuteFileBackerManager();
    const cacheBaker = new cache_backer_js_1.CacheBacker({
        cache: (_b = options.cache) !== null && _b !== void 0 ? _b : false,
        cacheLocation: (_c = options.cacheLocation) !== null && _c !== void 0 ? _c : node_path_1.default.resolve(process.cwd(), ".textlintcache"),
    ...
    return {
        ...
        async lintFiles(filesOrGlobs) {
            const patterns = (0, old_find_util_js_1.pathsToGlobPatterns)(filesOrGlobs, {
                extensions: options.descriptor.availableExtensions
            });
            const targetFiles = (0, old_find_util_js_1.findFiles)(patterns, {
        ...
        async fixFiles(fileOrGlobs) {
            const patterns = (0, old_find_util_js_1.pathsToGlobPatterns)(fileOrGlobs, {
                extensions: options.descriptor.availableExtensions
            });
            const targetFiles = (0, old_find_util_js_1.findFiles)(patterns, {
                ignoreFilePath: options.ignoreFilePath
