 ...
 */
import { TextlintKernelDescriptor, TextlintKernel } from "@textlint/kernel";
import fs from "node:fs";
import { filterRulesObjectToKernelRule, pluginsObjectToKernelRule, rulesObjectToKernelRule } from "../util/object-to-kernel-format.js";
...
export class TextLintCore {
    ...
    setupRules(rules = {}, rulesOption = {}) {
        Logger.deprecate("TextLintCore is deprecated. Please use new APIs https://github.com/textlint/textlint/issues/1310");
        this.textlintKernelDescriptor = this.textlintKernelDescriptor.shallowMerge({
