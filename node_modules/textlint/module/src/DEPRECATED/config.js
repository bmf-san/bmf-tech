...
export class Config {
    ...
    constructor(options = {}) {
         ...
         */
        this.disabledRules = applyNormalizerToList(normalizeTextlintRuleKey, options.disabledRules ? options.disabledRules : defaultOptions.disabledRules);
        /**
         * @type {string[]} rule key list
         * rules does not includes disabledRules
         */
        this.rules = applyNormalizerToList(normalizeTextlintRuleKey, options.rules ? options.rules : defaultOptions.rules).filter((ruleName) => {
         ...
         * These rule is set `false` to options
         */
        this.disabledFilterRules = applyNormalizerToList(normalizeTextlintFilterRuleKey, options.disabledFilterRules ? options.disabledFilterRules : defaultOptions.disabledFilterRules);
        /**
         * @type {string[]} filter rule key list
         */
        this.filterRules = applyNormalizerToList(normalizeTextlintFilterRuleKey, options.filterRules ? options.filterRules : defaultOptions.filterRules).filter((ruleName) => {
            return !this.disabledFilterRules.includes(ruleName);
        });
        /**
         * @type {string[]} preset key list
         */
        this.presets = applyNormalizerToList(normalizeTextlintRulePresetKey, options.presets ? options.presets : defaultOptions.presets);
        // => load plugins
        // this.rules has not contain plugin rules
        // =====================
        this.plugins = applyNormalizerToList(normalizeTextlintPluginKey, options.plugins ? options.plugins : defaultOptions.plugins);
        this.pluginsConfig = applyNormalizerToConfig(normalizeTextlintPluginKey, options.pluginsConfig ? options.pluginsConfig : defaultOptions.pluginsConfig);
        // rulesConfig
        ...
        this.rulesConfig = applyNormalizerToConfig(normalizeTextlintRuleKey, Object.assign({}, presetRulesConfig, options.rulesConfig));
        // filterRulesConfig
        this.filterRulesConfig = applyNormalizerToConfig(normalizeTextlintFilterRuleKey, options.filterRulesConfig || defaultOptions.filterRulesConfig);
        /**
         * @type {string[]}
         */
