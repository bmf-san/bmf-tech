...
- [x] 出力パス重複チェック追加（[PR #67](https://github.com/bmf-san/gohan/pull/67)）→ マージ済み・[v0.1.2](https://github.com/bmf-san/gohan/releases/tag/v0.1.2) リリース済み・`go install @v0.1.2` にピン留め済み